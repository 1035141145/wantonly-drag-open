<template>
    <div>
        <dv-decoration-11 :key="key" :style="{ color: element.style.color, 'font-size': element.style.color, 'font-weight': element.style.color }" :color="getColor">{{ element.style.borderTitle }}</dv-decoration-11>
    </div>
</template>
<script>
